...
class Search_cont extends StatelessWidget {
  final TextEditingController searchcontroller;
  final Customer u;

  Search_cont({super.key, required TextEditingController this.searchcontroller, required this.u});
...
class Categories extends StatelessWidget {
  final Customer u;
  Categories({super.key, required this.u});
            ...
            return Padding(
              ...
              child: ElevatedButton(
                ...
                onHover: (bool hovering){
                  if(hovering){
                    button_color = Color.fromRGBO(46, 46, 45, 1);
                  }
                },
                child: Column(
