  ...
  Widget build(BuildContext context) {
    return  Container(
      ...
      child: ClipRRect(
        ...
        child: image_url == '' || image_url == null ? Image.asset('assets/images/no-profile.jpg', fit: BoxFit.cover,) :
        Image.network(
          '$image_url',
          fit: BoxFit.cover,
...
class Preferences extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        const Text("Preferences", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 25, color: Colors.white, fontFamily: "Saira"),),
        ...
        ListTile(
          ...
          title: const Text("Account & Security", style: TextStyle(color: Colors.white, fontFamily: "Saira"),),
        ...
        ListTile(
          ...
          title: const Text("Help & Support", style: TextStyle(color: Colors.white, fontFamily: "Saira"),),
          trailing: const Icon(Icons.arrow_forward_ios, color: Colors.white,),
        ),
        const SizedBox(height: 10, ),
        Container(
